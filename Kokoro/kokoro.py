...
# Get the library path from the environment variable, or use a default
library_path = os.getenv("ESPEAK_LIBRARY_PATH", "/usr/lib/aarch64-linux-gnu/libespeak-ng.so.1")

# Set the library path for EspeakWrapper
